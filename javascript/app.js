...
(function() {
  var $, S, Splitter, autogrow, buffer, db, gui, handlebars, jonoeditor, marked, modal, ncp, path, rangyinputs, util;
  ...
  window.noted = {
    ...
    UIEvents: {
      clickNoteControls: function(id) {
        var mailto;
        if (id === "new" && window.noted.currentList !== "all") {
      ...
      clickNote: function(element) {
        ...
        element.addClass("selected");
        return window.noted.load.note(element.attr("data-id"));
      },
