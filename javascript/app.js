...
(function() {
  var $, Dropbox, S, Splitter, autogrow, buffer, db, gui, handlebars, http, jonoeditor, marked, modal, net, path, rangyinputs, util;
  ...
  window.noted = {
    ...
    init: function() {
      ...
      if ((_base1 = window.localStorage).cursor == null) {
        _base1.cursor = "";
      }
